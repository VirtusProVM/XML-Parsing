...
<html>
    ...
    <body>
        ...
        <!-- $carName/cars/car[manufacturer[contains(text(), $model)]] -->   
        <!-- $carName/cars/car[production-year > $fromYear and production-year < $toYear] -->
        <!-- $carName/cars/car[consumption/@type = $fuel] -->
        
        <%
            if(model.isEmpty() || model == null && fuel.isEmpty() || fuel == null) {
        %>
        <table>
            <tr>
                <th>Manufacturer</th>
       ...
       <%
           } else if(fromYear.equals(0) || toYear.equals(0) && fuel.isEmpty() || fuel == null) {
       %>
        ...
        <table>
            ...
            <x:forEach select="$carName/cars/car[manufacturer[contains(text(), $model)]]" var="item">
       ...
       <%
           } else if(fromYear.equals(0) || toYear.equals(0) && model.isEmpty() || model == null) {
       %>
       <table>
            <tr>
                <th>Manufacturer</th>
